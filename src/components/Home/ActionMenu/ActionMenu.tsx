...
import { ActionMenuContainer, CardBackground, TakePictureCard } from "./actionMenu-style";
    ...
    return (
        <ActionMenuContainer>
            <TakePictureCard>
                ...
                <Button colorScheme={"green"} style={{marginBottom: 16}} onPress={() => navigation.navigate("Camera") } >Tire uma foto</Button>
            </TakePictureCard>
        </ActionMenuContainer>
    );
}